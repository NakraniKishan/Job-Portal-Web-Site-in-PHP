...
<?php
  ...
  if(isset($btnsub))
  {
    $sel="select * from tblemployer where EmailId='$txtsendemail'";
    ...
    else
    {
      ...
      $pas="http://localhost/job/visempresetpass.php?fpcode=".$encode;
						...
						<div class="inner2">
							...
							<div class="page-breacrumbs">
								<ul class="breadcrumbs">
									<li><a href="visemplogin.php"> Employer Login</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="account-popup-area signin-popup-box static">
							<div class="account-popup">
								<form>
									...
									<button type="submit" name="btnsub" > Send Mail </button>
								</form>
							</div>
						</div><!-- LOGIN POPUP -->
					</div>
