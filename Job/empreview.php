...
extract($_REQUEST);
$selusr="select * from tblemployer where EmployerId=".$empid;
$rs=mysqli_query($con,$selusr) or die(mysqli_error($con));
$res=mysqli_fetch_array($rs);
$fname=$res["FirstName"];
$mname=$res["MiddleName"];
$lname=$res["LastName"];
if(is_null($res["ImageUrl"]))
{
	$usrimg="download.jpg";	
}
else
...
if(isset($txtsubrev))
{
	...
	$insrev="insert into tblreview values(null,$empid,null,'$txtdes',$r,now(),0)";
	mysqli_query($con,$insrev) or die(mysqli_error($con));
	header('location:empreview.php');
}
				 ...
				 <div class="row">
				 	<div class="col-lg-12 column">
				 		<div class="blog-single">
				 			<?php 
				 				$selrev="select * from tblreview where EmployerId=".$empid;
				 			...
				 			<div class="comment-sec">
				 				...
				 				<ul>
				 					...
				 					<li>
				 						<div class="comment">
				 							<div class="comment-avatar"> <img src="employer/employerimg/<?php echo $usrimg; ?>" alt="" /> </div>
