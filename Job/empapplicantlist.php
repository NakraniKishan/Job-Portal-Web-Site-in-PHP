...
extract($_REQUEST);
$seljobapplicant="select * from tbljobapply where IsShortListed=0 and JobPostId=".$_REQUEST["eid"];
					 		...
					 		<div class="emply-resume-sec">
					 			...
					 			<div class="emply-resume-list">
					 				...
					 				<div class="shortlists">
					 					<a href="?eid=<?php echo $_REQUEST["eid"]; ?>&shortlist=<?php echo $resseljobapplicant["JobApplyId"]; ?>" >Shortlist <i class="la la-plus"></i></a>
					 				</div>
					 			</div><!-- Emply List -->
					 			<?php
					 			}
