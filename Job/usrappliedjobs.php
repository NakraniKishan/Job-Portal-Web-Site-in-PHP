					 		...
					 		<div class="manage-jobs-sec">
						 		...
						 		<table>
						 			...
						 			<tbody>
						 				...
						 				<?php } elseif($resjobdel["IsShortListed"]==1) { $app++; $norecord="You Are ShortListed";
						 								$norecord1="You Are Been Shortlisted In ".$app." Applied Job"; } } } ?>
