				 			...
				 			<div class="row" id="masonry_abc">
				 				<div class="col-lg-4 a">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'a%' ";
				 							...
				 							?>	
				 								<li><a href="viscompanydetail.php?cmp=<?php echo $rescata["OrganizationId"]; ?>" ><?php echo $rescata["OrganizationName"]; ?></a></li>
				 							<?php }	
				 							}
				 							?>				 							
				 						</ul>
				 				...
				 				<div class="col-lg-4 b">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'b%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 c">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'c%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 d">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'd%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 e">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'e%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 f">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'f%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 g">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'g%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 h">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'h%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 i">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'i%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 j">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'j%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 k">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'k%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 l">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'l%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 m">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'M%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 n">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'n%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 o">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'o%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 p">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'p%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 q">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'q%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 r">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'r%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 s">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 's%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 t">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 't%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 U">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'u%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 v">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'v%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 w">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'w%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 x">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'x%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 y">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'y%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
				 				...
				 				<div class="col-lg-4 z">
				 					<div class="emply-text">
				 						...
				 						<ul>
				 							<?php
				 							$selcata="select * from tblorganization where IsActive=1 and OrganizationName like 'z%' ";
				 							$rscata=mysqli_query($con,$selcata) or die(mysqli_error($con)); 
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								$checkorg="	select * from tblemployer a
