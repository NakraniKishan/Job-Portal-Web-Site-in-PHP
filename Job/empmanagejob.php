...
if(isset($_REQUEST["actjob"]))
    { 
      ...
      { 
      	if($tempforbtn==1)
      	{
      		$upd="update tbljobpost set JobIsActive=1 where JobPostId='".$_REQUEST["actjob"]."'";
	        mysqli_query($con,$upd) or die(mysqli_error($con));	
      	}    
      }
      else
      {
        $upd="update tbljobpost set JobIsActive=0 where JobPostId='".$_REQUEST["actjob"]."'";
        mysqli_query($con,$upd) or die(mysqli_error($con));
      }
...
if(isset($didjob))
{
	$del1="delete from tblinquiry where JobPostId=".$didjob;
	$del2="delete from tbljobapply where JobPostId=".$didjob;
	$del3="delete from tblinquiry where JobPostId=".$didjob;
	$del="delete from tbljobpost where JobPostId=".$didjob;
				 	...
				 	<div class="col-lg-12 column">
				 		<div class="padding-left">
					 			...
					 			<div class="manage-jobs-sec">
					 					<h3>My Jobs<?php if($tempforbtn==1) { ?><a href="emppostjob.php">
					 					<button class="btnmain" style="margin-top: -10px;" >Post Job</button></a><?php } ?></h3>
					 					<?php if($cntjob>0) { ?>
						 			...
						 			?>
						 				<tr>
						 					...
						 					<td>
							                    <a href="?actjob=<?php echo $respostedjob["JobPostId"]; ?>&Status=<?php echo $respostedjob["JobIsActive"]; ?>">
							                    	<?php 
							                    		if($respostedjob["JobIsActive"]==1)
							                    		{
							                    	?>
						 					...
						 					<td>
						 						<a href="emppostjob.php?eid=<?php echo $respostedjob["JobPostId"]; ?>"><i class="fa fa-edit"></i></a>
						 					</td>
						 					<!-- <td>
						 					...
						 					<td>
						 						<a href="emppostjob.php?disid=<?php echo $respostedjob["JobPostId"]; ?>"><i class="fa fa-list"></i></a>
						 					</td>
						 				</tr>
						 				<?php
						 				}
