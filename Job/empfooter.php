			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 column">
						<div class="widget">
							<div class="about_widget">
								<div class="logo">
									<a><img src="images/resource/JOBsaware2.png" alt="" style="height:60px;" /></a>
					...
					<div class="col-lg-4 column">
						<div class="widget">
							<center><h3 class="footer-title" style="margin-left:-40px; ">Frequently Asked Questions</h3></center>
							<div class="link_widgets">
								<div class="row">
									<div class="col-lg-6">
										<a href="empabout.php" title="">About Us </a>
										<a href="empcontact.php" title="">Contact Us</a>	
									</div>
									
									<div class="col-lg-6">

										<a href="empcategory.php" title="">Browse Jobs By Category</a>
										<a href="emporganization.php" title="">Browse Jobs By Organization</a>
									</div>
								</div>
							</div>
						</div>
