							...
							<div class="link_widgets">
								<div class="row">
									<div class="col-lg-6">
										...
										<a href="usrcontact.php">Contact Us </a>	
									</div>
									
									<div class="col-lg-6">

										<a href="usrcategory.php">Browse Jobs By Category</a>
										<a href="usrcompany.php">Browse Jobs By Organization </a>
									</div>
								</div>
							</div>
						</div>
										...
										<?php
											$catcntfoot=0;
				 							...
				 							while($rescata=mysqli_fetch_array($rscata))
				 							{
				 								...
				 								{
				 							?>	
				 								<a href="usrselectedcat.php?catid=<?php echo $rescata["CategoryId"];  ?>"><?php echo $rescata["CategoryName"]; ?></a>
				 							<?php	
				 								}
				 								$catcntfoot++;
				 							}
