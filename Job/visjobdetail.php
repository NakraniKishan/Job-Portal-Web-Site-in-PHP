...
<?php
	 ...
	 if(isset($btninquiry))
	 {	
	 	$insinq="insert into tblinquiry values(null,'$txtfullname','$txtvisemail','$txtsubject','$txtdescrip',$postid,now(),0,null,null,null,null)";
	 	//echo $insinq;
				...
				<div class="row">
				 	<div class="col-lg-8 column">
				 		<div class="job-single-sec">
				 			...
				 			<div class="job-details">
				 				...
				 				<p><?php echo $resjobdetail["JobDescription"]; ?></p>
				 		...
				 		<div class="col-lg-4 column" >
								 		...
								 		<div class="quick-form-job" style="width:400px;">
								 			<h3>Inquiry</h3>
								 			<form method="Post">
								 				<input type="text" required="true" name="txtfullname" placeholder="Full Name" />
								 				<input type="email" required="true" name="txtvisemail" placeholder="Email" />
				 	...
				 	<div class="col-lg-4 column">
				 		<div class="job-single-head style2">
			 				...
			 				<a href="visuserlogin.php" class="apply-job-btn"><i class="la la-paper-plane"></i>Apply for job</a>
