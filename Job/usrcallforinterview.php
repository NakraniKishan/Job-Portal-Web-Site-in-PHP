		...
		<div class="block no-padding">
			<div class="container">
				 <div class="row no-gape">
				 	...
				 	<?php
				 	$seljobdel="select * from tbljobinterview a 
				 				left join tbljobapply b on a.JobApplyId=b.JobApplyId
				 				left join tblemployer c on a.EmployerId=c.EmployerId
				 				left join tblorganization d on c.OrganizationId=d.OrganizationId
				 				left join tbljobpostdetail e on b.JobPostDetailId=e.JobPostDetailId
				 				left join tblskill f on e.SkillId=f.SkillId
				 				left join tbljobpost g on b.JobPostId=g.JobPostId
				 				left join tblcategory h on g.JobCategory=h.CategoryId
					 		...
					 		<div class="manage-jobs-sec">
						 		...
						 		<table>
						 			...
						 			<tbody>
						 				...
						 				if($noofapplyjob==0)
						 				{
						 					$norecord="No Interview Calls";
						 					$norecord1="You are not call for any Interview";
						 				}
						 				else
						 				{
						 				...
						 				<tr>
						 					...
						 					<td>
						 						<div class="table-list-title">
						 							<span><?php echo $resjobdel["ScheduleDateTime"]; ?></span>
						 						</div>
						 					</td>
						 					
						 					<td>
						 						<ul class="action_job">
						 							<li><span>View More</span><a href="usrjobinterviewdetail.php?interid=<?php echo $resjobdel["JobInterviewId"]; ?>" title=""><i class="la la-eye"></i></a></li>
						 						</ul>
						 						<?php 
						 						if($resjobdel["IsSelected"]==1)
						 						{
