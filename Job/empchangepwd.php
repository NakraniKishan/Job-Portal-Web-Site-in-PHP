		...
		$old=$_POST["txtoldpass"];
      	...
      	if($tblpass==$old)
      	{
        	if($pass==$final)
        	{
          	...
          	$inspass="update tblemployer set Password='".$final."' where EmployerId=$empid";
          	//echo $inspass;
          	mysqli_query($con,$inspass) or die(mysqli_error($con));
          	header('location:empchangepwd.php');
        	}
	        else 
	        {
						 			...
						 			<form class="needs-validation" method="post">
						 				<div class="row">
						 					<div class="col-lg-6">
						 						...
						 						<div class="pf-field">
						 							<input type="password" name="txtoldpass" autofocus="" onblur="return ValidateControl('txtoldpass','lblinvalid','Old Password');" id="txtoldpass" />
