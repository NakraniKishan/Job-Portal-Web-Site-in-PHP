...
<?php
 $con=mysqli_connect("localhost","root","","job");
	...
	if(isset($subusrnewpass))
  {
    ...
    if($txtpassusr==$txtconpassusr)
    {
      $final=base64_encode($txtconpassusr);
      $inspass="update tblemployer set Password='".$final."' where EmailId='".$derecover."' ";
      //echo $inspass;
					...
					<div class="col-lg-12">
						<div class="account-popup-area signin-popup-box static">
							<div class="account-popup">
								<form method="Post">
									<div class="cfield">
										<input type="password" name="txtpassusr" required="true" id="txtpassusr" placeholder="Password" onblur="return ValidatePwd('txtpassusr','lbltxtpassusr','New Password');" />
										<i class="la la-key"></i>
									</div><isindex id="lbltxtpassusr" style="color: red;"></isindex>
									<i><?php if(isset($wrong)){ echo $wrong; } ?></i>
									<div class="cfield">
										<input type="password" name="txtconpassusr" required="true" id="txtconpassusr" placeholder="Confirm Password" onblur="ValidatePassword('txtpassusr','txtconpassusr','lblconpas');" />
										<i class="la la-key"></i>
									</div><isindex id="lblconpas" style="color: red;"></isindex>
									<i> </i>
