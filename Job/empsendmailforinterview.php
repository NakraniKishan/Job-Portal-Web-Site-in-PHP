...
<head>
	...
	<script type="text/javascript">
		function TDate() {
    var UserDate = document.getElementById("inqdate").value;
    var ToDate = new Date();
...
$selinqtosend="	select * from tbljobapply a
				left join tbluser b on a.UserId=b.UserId
 				where JobApplyId=".$_REQUEST["jobappid"];
...
$resinqtosend=mysqli_fetch_array($rsinqtosend);
  ...
  if(isset($btnsendinq))
  {
  	  $jobapply=$_REQUEST["jobappid"];	
  	  $imp=$inqsubject." ".$inqdate;
  	  $sceduledttime=$inqdate;
      $message = $txtinqdesc;
      $ins="insert into tbljobinterview values(null,$jobapply,$empid,'$sceduledttime','$txtinqdesc',0)";
...
$rsinqtosend=mysqli_query($con,$selinqtosend) or die(mysqli_error($con));
$resinqtosend=mysqli_fetch_array($rsinqtosend);
//echo $resinqtosend["EmailId"];
      require("PHPMailer_5.2.0/class.PHPMailer.php");
 		$mail = new PHPMailer();
 
        $email=$resinqtosend["EmailId"];
              				...
              				<form method="post" enctype="multipart/form-data">
					 			...
					 			<div class="profile-form-edit">
					 				<div class="row" style="margin-left: 10px;">
					 					...
					 					<div class="col-lg-12" style="margin-top: -20px;">
					 						<span class="pf-title">Schedule</span>
					 						<div class="pf-field">
					 							<?php $schdate= date("j-M-Y"); //echo $schdate; ?>
					 							<input type="date" onchange="return TDate()";  required="true" name="inqdate" id="inqdate" />
					 						</div>
					 					</div>
