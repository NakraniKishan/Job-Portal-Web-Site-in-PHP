					 			...
					 			<div class="manage-jobs-sec">
					 					...
					 					<table style="width:1000px;">
						 					<thead>
								 				<tr>
								 					...
								 					<td>Total Selected Applicants</td>
								 					<td>View Details</td>	
								 				</tr>
						 					</thead>
						 					<tbody>
						 			...
						 			?>
						 				<tr>
						 					...
						 					<?php 
						 					$selappshort="	select * from tbljobpost a 
						 									left join tbljobapply b on a.JobPostId=b.JobPostId
						 									where a.EmployerId=$empid and b.IsShortListed=1 and a.JobPostId=".$respostedjob["JobPostId"];
						 					// $selapp="select * from tbljobapply where IsShortListed=0 and JobPostId=".$respostedjob["JobPostId"]; 
						 					$rsselappshort=mysqli_query($con,$selappshort) or die(mysqli_error($con));
						 					$cntappjobshort=mysqli_num_rows($rsselappshort); 
						 					?>
						 					<td>
						 						<?php echo $cntappjobshort; ?>
						 					</td>
						 					<td>
						 						<?php if($cntappjob!=$cntappjobshort) { ?><a href="empapplicantlist.php?eid=<?php echo $respostedjob["JobPostId"]; ?>"><i class="fa fa-list"></i></a>
						 						<?php } ?>
						 					</td>
						 				</tr>
						 				<?php
