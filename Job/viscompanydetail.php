											 	...
											 	<div class="job-listings-sec no-border">
													...
													<div class="job-listing wtabs">
														<div class="job-title-sec">
															...
															<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="visjobdetail.php?jobid=<?php echo $rescompjob["JobPostId"]; ?>" title=""><?php echo $rescompjob["SkillName"]; ?></a></h3>
															<!-- <span><?php echo $rescompjob["JobDescription"]; ?></span> -->
														...
														<div class="job-style-bx">
															<span class="job-is ft"><a href="visuserlogin.php"> Apply</a></span>
